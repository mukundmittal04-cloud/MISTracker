...
app.listen(CONFIG.PORT,function(){
  console.log('\nFidato MIS Server v2.11.0-s6.9 | Port:',CONFIG.PORT,'| Vision:',CONFIG.CLAUDE_API_KEY?'enabled':'disabled');
