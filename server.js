...
app.listen(CONFIG.PORT,function(){
  console.log('\nFidato MIS Server v2.10.0-s5.11 | Port:',CONFIG.PORT,'| Vision:',CONFIG.CLAUDE_API_KEY?'enabled':'disabled');
